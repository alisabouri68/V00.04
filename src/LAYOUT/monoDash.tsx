...
import CANV from "CONS/CONS_demo";
...
function Main() {
  ...
  return (
    <>
      <div className="w-9/12 bg-white rounded-xl shadow-md p-6">
            ...
            ?.map((item) => {
              ...
              return (
                <div
                  ...
                  onClick={() => {
                    navigate(
                      `/view/bioDemo/monoDash/${item.slug}/${item?.sheets?.[0]?.slug}`,
                      {
                        flushSync: true,
                      }
                    );
                        ...
                        ?.map((item: any) => {
                          ...
                          return (
                            <div
                              ...
                              onClick={() => {
                                navigate(
                                  `/view/bioDemo/monoDash/${service?.slug}/${item.slug}`,
                                  {
                                    flushSync: true,
                                  }
                                );
