    ...
    <div className="flex items-center justify-between w-full bg-light text-dark relative">
        ...
        <Text
          className={`${
            prevCount
              ...
              : "opacity-0 invisible !text-transparent"
          } hidden text-xs bg-primary rounded-full w-4 h-4 lg:flex items-center justify-center shadow-sm`}
        >
          {prevCount}
        </Text>
      </div>
      ...
      <div className="flex items-center space-x-2">
        <Button
          ...
          } text-stone-700 dark:hover:bg-stone-900 hover:bg-stone-300 p-2 rounded-full transition-all duration-300`}
        />
        <Text
          className={`${
            nextCount > 0
              ? "opacity-100 visible text-white"
              : "opacity-0 invisible !text-transparent"
          } hidden lg:flex text-xs ms-2 bg-primary rounded-full w-4 h-4 items-center justify-center shadow-sm`}
        >
          {nextCount}
        </Text>
        <Button
