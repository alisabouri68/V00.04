...
const LayoutComposer = ({ console, actionChild, auxilaryChild, assistantChild }: { console: string; actionChild: ReactNode; auxilaryChild: ReactNode; assistantChild: ReactNode }) => {
  ...
  return (
    <Suspense fallback={<LoadingIndicator />}>
      <BaseLayout>
        <HeaderLayout staticMobileStyle="h-[10vh]">
          {HeaderBox && <HeaderBox console={console} />}
        </HeaderLayout>

        <div className="flex flex-1 p-1 overflow-hidden flex-col-reverse lg:flex-row flex-grow">
          <NavigatorLayout staticMobileStyle="h-[15vh]" >
            {NavigatorBox && (
              <NavigatorBox>
          ...
          <main className="flex items-center h-[75vh] lg:h-full ">
            {/* Action Section */}
