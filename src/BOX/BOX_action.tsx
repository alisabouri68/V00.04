...
//             <div className="w-9/12 flex flex-col gap-2 h-screen">
//                 <Jinni />
                
//                 {/* Primary white content panel */}
//                 <div className="w-full bg-light rounded-xl shadow-md p-6 h-full">
//                     {/* Header Section with logo, user avatars and action buttons */}
//                     <div className="flex justify-between">
//                         {/* App logo and name */}
//                         <div className="flex gap-2 items-center">
//                             <FontAwesomeIcon className="w-4 h-4 text-gray-400" icon={faGear} />
//                             <span className="font-bold text-gray-400">TRIPOD</span>
//                         </div>
...
//                     <div className="flex flex-row flex-wrap bg-teal-100 p-3 rounded-lg my-3 gap-2 w-full">
...
//                     <div >
//                         <button className="flex items-center mt-3" onClick={() => setShowMenu(!showMenu)}>
